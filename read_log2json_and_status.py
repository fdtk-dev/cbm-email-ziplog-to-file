...
def showhardconf_status(hostname, host_dict):
    ...
    if mem_match:
        host_dict[hostname]["Status"]["MEM#00A Status"] = re.split("\W+", mem_match[0])[
            -2
        ]
        host_dict[hostname]["Status"]["MEM#01A Status"] = re.split("\W+", mem_match[1])[
            -2
        ]
        host_dict[hostname]["Status"]["MEM#02A Status"] = re.split("\W+", mem_match[2])[
            -2
        ]
        host_dict[hostname]["Status"]["MEM#03A Status"] = re.split("\W+", mem_match[3])[
            -2
        ]
        if (
            len(mem_match) > 4
    ...
    if psu_match:
        host_dict[hostname]["Status"]["PSU#0 Status"] = re.split("\W+", psu_match[0])[
            -2
        ]
        host_dict[hostname]["Status"]["PSU#1 Status"] = re.split("\W+", psu_match[1])[
            -2
        ]
    ...
    if fan_match:
        host_dict[hostname]["Status"]["FANU#0 Status"] = re.split("\W+", fan_match[0])[
            -2
        ]
        host_dict[hostname]["Status"]["FANU#1 Status"] = re.split("\W+", fan_match[1])[
            -2
        ]
        host_dict[hostname]["Status"]["FANU#2 Status"] = re.split("\W+", fan_match[2])[
            -2
        ]
        host_dict[hostname]["Status"]["FANU#3 Status"] = re.split("\W+", fan_match[3])[
            -2
        ]
        host_dict[hostname]["Status"]["FANU#4 Status"] = re.split("\W+", fan_match[4])[
            -2
        ]
        host_dict[hostname]["Status"]["FANU#5 Status"] = re.split("\W+", fan_match[5])[
            -2
        ]
        host_dict[hostname]["Status"]["FANU#6 Status"] = re.split("\W+", fan_match[6])[
            -2
        ]
